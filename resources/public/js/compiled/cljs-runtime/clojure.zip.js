...
var G__52011 = clojure.zip.node(loc);
var fexpr__52010 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__52010.cljs$core$IFn$_invoke$arity$1 ? fexpr__52010.cljs$core$IFn$_invoke$arity$1(G__52011) : fexpr__52010.call(null,G__52011));
});
/**
...
var G__52014 = clojure.zip.node(loc);
var fexpr__52013 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__52013.cljs$core$IFn$_invoke$arity$1 ? fexpr__52013.cljs$core$IFn$_invoke$arity$1(G__52014) : fexpr__52013.call(null,G__52014));
} else {
...
var fexpr__52015 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__52015.cljs$core$IFn$_invoke$arity$2 ? fexpr__52015.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__52015.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__52018 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52018,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52018,(1),null);
var vec__52021 = clojure.zip.children(loc);
...
var vec__52028 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52028,(0),null);
var map__52031 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52028,(1),null);
var map__52031__$1 = cljs.core.__destructure_map(map__52031);
var path = map__52031__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52031__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52031__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52031__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52031__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52031__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__52032 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52032,(0),null);
var map__52035 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52032,(1),null);
var map__52035__$1 = cljs.core.__destructure_map(map__52035);
var path = map__52035__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52035__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__52036 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52035__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__52048 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52048,(0),null);
var map__52051 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52048,(1),null);
var map__52051__$1 = cljs.core.__destructure_map(map__52051);
var path = map__52051__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52051__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52051__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return r;
} else {
...
var vec__52052 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52052,(0),null);
var map__52055 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52052,(1),null);
var map__52055__$1 = cljs.core.__destructure_map(map__52055);
var path = map__52055__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52055__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52055__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
...
var vec__52056 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52056,(0),null);
var map__52059 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52056,(1),null);
var map__52059__$1 = cljs.core.__destructure_map(map__52059);
var path = map__52059__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52059__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52059__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4251__auto__ = path;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__52060 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52060,(0),null);
var map__52063 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52060,(1),null);
var map__52063__$1 = cljs.core.__destructure_map(map__52063);
var path = map__52063__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52063__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__52064 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52064,(0),null);
var map__52067 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52064,(1),null);
var map__52067__$1 = cljs.core.__destructure_map(map__52067);
var path = map__52067__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52067__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__52068 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52068,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52068,(1),null);
...
var len__4864__auto___52114 = arguments.length;
var i__4865__auto___52115 = (0);
while(true){
if((i__4865__auto___52115 < len__4864__auto___52114)){
args__4870__auto__.push((arguments[i__4865__auto___52115]));

var G__52116 = (i__4865__auto___52115 + (1));
i__4865__auto___52115 = G__52116;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq52071){
var G__52072 = cljs.core.first(seq52071);
var seq52071__$1 = cljs.core.next(seq52071);
var G__52073 = cljs.core.first(seq52071__$1);
var seq52071__$2 = cljs.core.next(seq52071__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52072,G__52073,seq52071__$2);
}));
...
var G__52129 = clojure.zip.rightmost(child);
loc__$1 = G__52129;
continue;
} else {
return loc__$1;
...
var vec__52085 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52085,(0),null);
var map__52088 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52085,(1),null);
var map__52088__$1 = cljs.core.__destructure_map(map__52088);
var path = map__52088__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52088__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52088__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52088__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52088__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__52130 = clojure.zip.rightmost(child);
loc__$1 = G__52130;
continue;
} else {
return loc__$1;
