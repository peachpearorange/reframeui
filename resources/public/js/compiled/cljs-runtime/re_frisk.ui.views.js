...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.components.scroller,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"#f3f3f3"], null)], null),(function (){var iter__4652__auto__ = (function re_frisk$ui$views$app_db_view_$_iter__48585(s__48586){
return (new cljs.core.LazySeq(null,(function (){
var s__48586__$1 = s__48586;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__48586__$1);
if(temp__5753__auto__){
var s__48586__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48586__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__48586__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__48588 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__48587 = (0);
while(true){
if((i__48587 < size__4651__auto__)){
var watcher = cljs.core._nth(c__4650__auto__,i__48587);
cljs.core.chunk_append(b__48588,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.views.watch_item,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(app_db_derefed,watcher),watcher,watchers], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),watcher], null)));

var G__48603 = (i__48587 + (1));
i__48587 = G__48603;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48588),re_frisk$ui$views$app_db_view_$_iter__48585(cljs.core.chunk_rest(s__48586__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48588),null);
}
} else {
var watcher = cljs.core.first(s__48586__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.views.watch_item,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(app_db_derefed,watcher),watcher,watchers], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),watcher], null)),re_frisk$ui$views$app_db_view_$_iter__48585(cljs.core.rest(s__48586__$2)));
}
} else {
return null;
}
...
var map__48589 = cljs.core.deref(tool_state);
var map__48589__$1 = cljs.core.__destructure_map(map__48589);
var timeline_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48589__$1,new cljs.core.Keyword(null,"timeline-opened?","timeline-opened?",1560712236));
var paused_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48589__$1,new cljs.core.Keyword(null,"paused?","paused?",-135058553));
var graph_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48589__$1,new cljs.core.Keyword(null,"graph-opened?","graph-opened?",153449318));
var stat_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48589__$1,new cljs.core.Keyword(null,"stat-opened?","stat-opened?",1063397443));
var views_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48589__$1,new cljs.core.Keyword(null,"views-opened?","views-opened?",-1040443216));
...
var len__4864__auto___48604 = arguments.length;
var i__4865__auto___48605 = (0);
while(true){
if((i__4865__auto___48605 < len__4864__auto___48604)){
args__4870__auto__.push((arguments[i__4865__auto___48605]));

var G__48606 = (i__4865__auto___48605 + (1));
i__4865__auto___48605 = G__48606;
continue;
} else {
}
break;
...
(re_frisk.ui.views.main_view.cljs$core$IFn$_invoke$arity$variadic = (function (re_frame_data,tool_state,p__48595){
var vec__48596 = p__48595;
var doc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48596,(0),null);
...
/** @this {Function} */
(re_frisk.ui.views.main_view.cljs$lang$applyTo = (function (seq48592){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48593,G__48594,seq48592__$2);
}));
