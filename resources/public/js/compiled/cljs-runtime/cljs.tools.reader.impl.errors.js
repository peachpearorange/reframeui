...
args__4870__auto__.push((arguments[i__4865__auto___42001]));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq41934){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41935,G__41936,seq41934__$2);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___42003 = arguments.length;
var i__4865__auto___42004 = (0);
while(true){
if((i__4865__auto___42004 < len__4864__auto___42003)){
args__4870__auto__.push((arguments[i__4865__auto___42004]));

var G__42005 = (i__4865__auto___42004 + (1));
i__4865__auto___42004 = G__42005;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq41943){
var G__41944 = cljs.core.first(seq41943);
var seq41943__$1 = cljs.core.next(seq41943);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41944,seq41943__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___42006 = arguments.length;
var i__4865__auto___42007 = (0);
while(true){
if((i__4865__auto___42007 < len__4864__auto___42006)){
args__4870__auto__.push((arguments[i__4865__auto___42007]));

var G__42008 = (i__4865__auto___42007 + (1));
i__4865__auto___42007 = G__42008;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq41945){
var G__41946 = cljs.core.first(seq41945);
var seq41945__$1 = cljs.core.next(seq41945);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41946,seq41945__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___42009 = arguments.length;
var i__4865__auto___42010 = (0);
while(true){
if((i__4865__auto___42010 < len__4864__auto___42009)){
args__4870__auto__.push((arguments[i__4865__auto___42010]));

var G__42011 = (i__4865__auto___42010 + (1));
i__4865__auto___42010 = G__42011;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq41947){
var G__41948 = cljs.core.first(seq41947);
var seq41947__$1 = cljs.core.next(seq41947);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41948,seq41947__$1);
}));
...
var args__4870__auto__ = [];
var len__4864__auto___42013 = arguments.length;
var i__4865__auto___42014 = (0);
while(true){
if((i__4865__auto___42014 < len__4864__auto___42013)){
args__4870__auto__.push((arguments[i__4865__auto___42014]));

var G__42015 = (i__4865__auto___42014 + (1));
i__4865__auto___42014 = G__42015;
continue;
} else {
}
break;
...
var init = (function (){var G__41969 = kind;
var G__41969__$1 = (((G__41969 instanceof cljs.core.Keyword))?G__41969.fqn:null);
switch (G__41969__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41969__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq41966){
...
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41967,G__41968,seq41966__$2);
}));
...
var iter__4652__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41990(s__41991){
return (new cljs.core.LazySeq(null,(function (){
var s__41991__$1 = s__41991;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__41991__$1);
if(temp__5753__auto__){
var s__41991__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__41991__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__41991__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__41993 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__41992 = (0);
while(true){
if((i__41992 < size__4651__auto__)){
var vec__41994 = cljs.core._nth(c__4650__auto__,i__41992);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41994,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41994,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__41993,id);

var G__42017 = (i__41992 + (1));
i__41992 = G__42017;
continue;
} else {
var G__42018 = (i__41992 + (1));
i__41992 = G__42018;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__41993),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41990(cljs.core.chunk_rest(s__41991__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__41993),null);
}
} else {
var vec__41997 = cljs.core.first(s__41991__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41997,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41997,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__41990(cljs.core.rest(s__41991__$2)));
} else {
var G__42019 = cljs.core.rest(s__41991__$2);
s__41991__$1 = G__42019;
continue;
}
}
} else {
