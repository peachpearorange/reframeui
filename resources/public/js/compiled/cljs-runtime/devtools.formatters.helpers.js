...
var G__39050 = devtools.prefs.pref(v);
v = G__39050;
continue;
} else {
return v;
...
}catch (e38929){var _e__36230__auto__ = e38929;
return false;
}})();
...
}catch (e38938){var _e__36230__auto__ = e38938;
return false;
}})();
...
}catch (e38948){var _e__36230__auto__ = e38948;
return false;
}}
}
});
...
var vec__39002 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39002,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39002,(1),null);
...
return cljs.core.some((function (p1__39034_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39034_SHARP_);
}),template);
});
