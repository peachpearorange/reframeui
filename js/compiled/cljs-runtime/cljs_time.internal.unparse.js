...
var periods__$1 = cljs.core.vec((function (){var G__43842 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43841_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__43841_SHARP_,(0),(3));
}),G__43842);
} else {
return G__43842;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__43851){
var vec__43852 = p__43851;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43852,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43852,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__43855 = pattern;
switch (G__43855) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43855)].join('')));
...
switch (G__43865__$1) {
case "millis":
return (function (p1__43857_SHARP_){
return p1__43857_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__43858_SHARP_){
return p1__43858_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__43859_SHARP_){
return p1__43859_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__43860_SHARP_){
return p1__43860_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__43861_SHARP_){
return p1__43861_SHARP_.getHours();
});

break;
case "day":
return (function (p1__43862_SHARP_){
return p1__43862_SHARP_.getDate();
});

break;
case "month":
return (function (p1__43863_SHARP_){
return p1__43863_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__43864_SHARP_){
return p1__43864_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43865__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__43866){
...
break;
case "ordinal-suffix":
var vec__43871 = (function (){var G__43874 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__43874) : syntax_list.call(null,G__43874));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43870__$1)].join('')));
...
var d = value;
var G__43878 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__43879 = G__43878;
...
var unparser = first__43881;
var more = seq__43880__$1;
var s = "";
var d__$1 = d;
var G__43878__$1 = G__43878;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__43888 = G__43878__$1;
...
var unparser__$1 = first__43890;
var more__$1 = seq__43889__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__43891 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43891,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43891,(1),null);
var G__43926 = d__$3;
var G__43927 = more__$1;
var G__43928 = s__$3;
d__$1 = G__43926;
G__43878__$1 = G__43927;
s__$1 = G__43928;
continue;
}
break;
