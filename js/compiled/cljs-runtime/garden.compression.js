 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__54356){
var vec__54357 = p__54356;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54357,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54357,(1),null);
return (function (s){
...
var len__4864__auto___54375 = arguments.length;
var i__4865__auto___54376 = (0);
while(true){
if((i__4865__auto___54376 < len__4864__auto___54375)){
args__4870__auto__.push((arguments[i__4865__auto___54376]));

var G__54379 = (i__4865__auto___54376 + (1));
i__4865__auto___54376 = G__54379;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__54360_SHARP_){
return (p1__54360_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__54360_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__54360_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq54361){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54361));
}));
...
var map__54366 = temp__5751__auto__;
var map__54366__$1 = cljs.core.__destructure_map(map__54366);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54366__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54366__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54366__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__54383 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__54384 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__54368 = tag;
var G__54368__$1 = (((G__54368 instanceof cljs.core.Keyword))?G__54368.fqn:null);
switch (G__54368__$1) {
case "string":
return chunk;
