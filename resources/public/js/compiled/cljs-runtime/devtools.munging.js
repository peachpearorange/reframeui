...
var o38688 = temp__5751__auto__;
var temp__5751__auto____$1 = (o38688["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o38689 = temp__5751__auto____$1;
return (o38689["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36195__auto__ = f;
return (o__36195__auto__["toString"]).call(o__36195__auto__);
} else {
return "";
}
}catch (e38690){var _ = e38690;
return "";
}});
...
try{var o__36195__auto___38912 = t;
(o__36195__auto___38912["cljs$lang$ctorPrWriter"]).call(o__36195__auto___38912,t,writer);
}catch (e38704){var __38913 = e38704;
}
...
var char_code = (function (){var o__36195__auto__ = (new String(char$));
return (o__36195__auto__["charCodeAt"]).call(o__36195__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36195__auto__ = String;
return (o__36195__auto__["fromCharCode"]).call(o__36195__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38713 = num_code;
switch (G__38713) {
case (1):
return (185);
...
var o__36195__auto__ = String;
return (o__36195__auto__["fromCharCode"]).call(o__36195__auto__,superscript_code);
});
/**
...
}catch (e38714){var _e__36230__auto__ = e38714;
return false;
}})())){
...
var vec__38715 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38715,(0),null);
...
var len__4864__auto___38920 = arguments.length;
var i__4865__auto___38922 = (0);
while(true){
if((i__4865__auto___38922 < len__4864__auto___38920)){
args__4870__auto__.push((arguments[i__4865__auto___38922]));

var G__38923 = (i__4865__auto___38922 + (1));
i__4865__auto___38922 = G__38923;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38733){
var vec__38734 = p__38733;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38734,(0),null);
...
var G__38932 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__38933 = cljs.core.butlast(remaining_tokens);
name_tokens = G__38932;
remaining_tokens = G__38933;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38731){
var G__38732 = cljs.core.first(seq38731);
var seq38731__$1 = cljs.core.next(seq38731);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38732,seq38731__$1);
}));
...
var vec__38749 = cljs.core.split_with((function (p1__38748_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__38748_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38749,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38749,(1),null);
...
var vec__38755 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38755,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38755,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__38940 = cljs.core.rest(remaining_tokens);
var G__38941 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__38940;
name_tokens = G__38941;
continue;
} else {
...
var vec__38760 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38760,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38760,(1),null);
var vec__38763 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38763,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38763,(1),null);
var vec__38766 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38766,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38766,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38766,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38766,(3),null);
...
var vec__38771 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38771,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38771,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38771,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38771,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38771,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38771,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__38774 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38774,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38774,(1),null);
var vec__38777 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__38780 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__38780) : devtools.munging.parse_fn_info_deep.call(null,G__38780));
})()));
}
} else {
return fn_info;
...
var G__38995 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38782){
var vec__38783 = p__38782;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38783,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38783,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38788_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__38788_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38789_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__38789_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___39005 = arguments.length;
var i__4865__auto___39006 = (0);
while(true){
if((i__4865__auto___39006 < len__4864__auto___39005)){
args__4870__auto__.push((arguments[i__4865__auto___39006]));

var G__39007 = (i__4865__auto___39006 + (1));
i__4865__auto___39006 = G__39007;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38796){
var vec__38797 = p__38796;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38797,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38794){
var G__38795 = cljs.core.first(seq38794);
var seq38794__$1 = cljs.core.next(seq38794);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38795,seq38794__$1);
}));
...
var G__38800 = arg;
var G__38800__$1 = (((G__38800 instanceof cljs.core.Keyword))?G__38800.fqn:null);
switch (G__38800__$1) {
...
var map__38816 = options;
var map__38816__$1 = cljs.core.__destructure_map(map__38816);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38816__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38816__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38816__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38816__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38817 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38817,(5),null);
...
var o__36195__auto__ = f;
return (o__36195__auto__["getBasis"]).call(o__36195__auto__);
});
/**
...
}catch (e38832){var _e__36230__auto__ = e38832;
...
var G__39009 = (obj[cljs.core.first(path)]);
var G__39010 = cljs.core.rest(path);
obj = G__39009;
path = G__39010;
continue;
} else {
...
var _STAR_ = (function (accum,p__38870){
var vec__38873 = p__38870;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38873,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38873,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__38896){
var vec__38898 = p__38896;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38898,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38898,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38898,(2),null);
...
var post_process = (function (p__38908){
var vec__38909 = p__38908;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38909,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38909,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38907_SHARP_){
return (obj[cljs.core.first(p1__38907_SHARP_)]);
}),sorted_matches);
