...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49687 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_49687(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_49688 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_49688(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_49690 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_49690(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_49692 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_49692(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49707 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_49707(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49721 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_49721(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__49553,callback){
var map__49555 = p__49553;
var map__49555__$1 = cljs.core.__destructure_map(map__49555);
var input = map__49555__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49555__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49555__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
