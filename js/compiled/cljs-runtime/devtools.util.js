...
var len__4864__auto___38436 = arguments.length;
var i__4865__auto___38437 = (0);
while(true){
if((i__4865__auto___38437 < len__4864__auto___38436)){
args__4870__auto__.push((arguments[i__4865__auto___38437]));

var G__38438 = (i__4865__auto___38437 + (1));
i__4865__auto___38437 = G__38438;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__38374_38439 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__38375_38440 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__38376_38441 = true;
var _STAR_print_fn_STAR__temp_val__38377_38442 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__38376_38441);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__38377_38442);

try{var _STAR_print_level_STAR__orig_val__38378_38443 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__38379_38444 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__38379_38444);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__38378_38443);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__38375_38440);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__38374_38439);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq38373){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq38373));
}));
...
var new_formatters = current_formatters.filter((function (p1__38409_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__38409_SHARP_)));
}));
...
var G__38410_38455 = f;
var target__36228__auto___38456 = G__38410_38455;
if(cljs.core.truth_(target__36228__auto___38456)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38410_38455)].join(''),"\n","target__36228__auto__"].join('')));
}

(target__36228__auto___38456["toString"] = (function (){
...
var G__38411_38466 = "%c%s";
var G__38412_38467 = "color:transparent";
var G__38413_38468 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__38411_38466,G__38412_38467,G__38413_38468) : f.call(null,G__38411_38466,G__38412_38467,G__38413_38468));
...
var args__4870__auto__ = [];
var len__4864__auto___38469 = arguments.length;
var i__4865__auto___38470 = (0);
while(true){
if((i__4865__auto___38470 < len__4864__auto___38469)){
args__4870__auto__.push((arguments[i__4865__auto___38470]));

var G__38472 = (i__4865__auto___38470 + (1));
i__4865__auto___38470 = G__38472;
continue;
} else {
}
break;
...
var vec__38421 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38421,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38421,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__38474__delegate = function (add_fmt,add_args){
...
var G__38474 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__38477__i = 0, G__38477__a = new Array(arguments.length -  1);
while (G__38477__i < G__38477__a.length) {G__38477__a[G__38477__i] = arguments[G__38477__i + 1]; ++G__38477__i;}
  add_args = new cljs.core.IndexedSeq(G__38477__a,0,null);
} 
return G__38474__delegate.call(this,add_fmt,add_args);};
G__38474.cljs$lang$maxFixedArity = 1;
G__38474.cljs$lang$applyTo = (function (arglist__38478){
var add_fmt = cljs.core.first(arglist__38478);
var add_args = cljs.core.rest(arglist__38478);
return G__38474__delegate(add_fmt,add_args);
});
G__38474.cljs$core$IFn$_invoke$arity$variadic = G__38474__delegate;
return G__38474;
})()
);
}));
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq38415){
var G__38416 = cljs.core.first(seq38415);
var seq38415__$1 = cljs.core.next(seq38415);
var G__38417 = cljs.core.first(seq38415__$1);
var seq38415__$2 = cljs.core.next(seq38415__$1);
var G__38418 = cljs.core.first(seq38415__$2);
var seq38415__$3 = cljs.core.next(seq38415__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38416,G__38417,G__38418,seq38415__$3);
}));
...
var seq__38424 = cljs.core.seq(features);
var chunk__38425 = null;
var count__38426 = (0);
var i__38427 = (0);
while(true){
if((i__38427 < count__38426)){
var feature = chunk__38425.cljs$core$IIndexed$_nth$arity$2(null,i__38427);
...
var G__38491 = seq__38424;
var G__38492 = chunk__38425;
var G__38493 = count__38426;
var G__38494 = (i__38427 + (1));
seq__38424 = G__38491;
chunk__38425 = G__38492;
count__38426 = G__38493;
i__38427 = G__38494;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__38424);
if(temp__5753__auto__){
var seq__38424__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38424__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__38424__$1);
var G__38499 = cljs.core.chunk_rest(seq__38424__$1);
var G__38500 = c__4679__auto__;
var G__38501 = cljs.core.count(c__4679__auto__);
var G__38502 = (0);
seq__38424 = G__38499;
chunk__38425 = G__38500;
count__38426 = G__38501;
i__38427 = G__38502;
continue;
} else {
var feature = cljs.core.first(seq__38424__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__38529 = cljs.core.next(seq__38424__$1);
var G__38530 = null;
var G__38531 = (0);
var G__38532 = (0);
seq__38424 = G__38529;
chunk__38425 = G__38530;
count__38426 = G__38531;
i__38427 = G__38532;
continue;
}
} else {
...
var G__38428 = feature;
var G__38428__$1 = (((G__38428 instanceof cljs.core.Keyword))?G__38428.fqn:null);
switch (G__38428__$1) {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o38431 = temp__5751__auto__;
return (o38431["version"]);
} else {
return null;
}
})() == null);
