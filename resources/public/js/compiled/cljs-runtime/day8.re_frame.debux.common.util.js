...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__53392){
var vec__53393 = p__53392;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53393,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53393,(1),null);
...
return clojure.zip.zipper((function (p1__53397_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__53397_SHARP_)) || (cljs.core.map_QMARK_(p1__53397_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__53406){
var vec__53407 = p__53406;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53407,(0),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53413_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53413_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53412_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53412_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53414_SHARP_){
return (((p1__53414_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53414_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__53429,mapping){
var map__53431 = p__53429;
var map__53431__$1 = cljs.core.__destructure_map(map__53431);
var state = map__53431__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53431__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53431__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53431__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53428_SHARP_){
var and__4251__auto__ = (p1__53428_SHARP_ instanceof cljs.core.Symbol);
if(and__4251__auto__){
return cljs.core.namespace(p1__53428_SHARP_);
} else {
...
var G__53518 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__53519 = clojure.zip.next(loc);
loc = G__53519;
continue;
}
}
...
var len__4864__auto___53526 = arguments.length;
var i__4865__auto___53527 = (0);
while(true){
if((i__4865__auto___53527 < len__4864__auto___53526)){
args__4870__auto__.push((arguments[i__4865__auto___53527]));

var G__53528 = (i__4865__auto___53527 + (1));
i__4865__auto___53527 = G__53528;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53450){
var vec__53451 = p__53450;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53451,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq53447){
var G__53448 = cljs.core.first(seq53447);
var seq53447__$1 = cljs.core.next(seq53447);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53448,seq53447__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53454_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53454_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53457_53532 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53458_53533 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53459_53534 = true;
var _STAR_print_fn_STAR__temp_val__53460_53535 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53459_53534);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53460_53535);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53458_53533);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53457_53532);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53456_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__53456_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__53537 = cljs.core.next(opts__$1);
var G__53538 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__53537;
acc = G__53538;
continue;
} else {
if(typeof f === 'string'){
var G__53539 = cljs.core.next(opts__$1);
var G__53540 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__53539;
acc = G__53540;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__53541 = cljs.core.nnext(opts__$1);
var G__53542 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__53541;
acc = G__53542;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__53543 = cljs.core.next(opts__$1);
var G__53544 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__53543;
acc = G__53544;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53465 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__53465.cljs$core$IFn$_invoke$arity$1 ? fexpr__53465.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53465.call(null,f));
})())){
var G__53545 = cljs.core.next(opts__$1);
var G__53546 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__53545;
acc = G__53546;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53466 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__53466.cljs$core$IFn$_invoke$arity$1 ? fexpr__53466.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53466.call(null,f));
})())){
var G__53547 = cljs.core.nnext(opts__$1);
var G__53548 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53547;
acc = G__53548;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__53549 = cljs.core.next(opts__$1);
var G__53550 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53549;
acc = G__53550;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__53467){
var vec__53468 = p__53467;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53468,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53468,(1),null);
...
var G__53475 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__53474 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53484 = quoted_form;
var G__53485 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53484,G__53485) : day8.re_frame.debux.common.util.remove_d.call(null,G__53484,G__53485));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53496 = quoted_form;
var G__53497 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53496,G__53497) : day8.re_frame.debux.common.util.remove_d.call(null,G__53496,G__53497));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__53555__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53504 = quoted_form;
var G__53505 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53504,G__53505) : day8.re_frame.debux.common.util.remove_d.call(null,G__53504,G__53505));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__53555 = function (var_args){
var arg = null;
...
while (G__53556__i < G__53556__a.length) {G__53556__a[G__53556__i] = arguments[G__53556__i + 0]; ++G__53556__i;}
  arg = new cljs.core.IndexedSeq(G__53556__a,0,null);
} 
return G__53555__delegate.call(this,arg);};
G__53555.cljs$lang$maxFixedArity = 0;
G__53555.cljs$lang$applyTo = (function (arglist__53557){
var arg = cljs.core.seq(arglist__53557);
return G__53555__delegate(arg);
});
G__53555.cljs$core$IFn$_invoke$arity$variadic = G__53555__delegate;
return G__53555;
})()
;
});
...
var G__53558 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53558;
continue;
} else {
...
var G__53559 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53559;
continue;
} else {
var G__53560 = clojure.zip.next(loc);
loc = G__53560;
continue;
