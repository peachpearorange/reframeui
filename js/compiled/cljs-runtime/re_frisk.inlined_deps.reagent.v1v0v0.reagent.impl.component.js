...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41488 = c;
var G__41488__$1 = (((G__41488 == null))?null:G__41488.prototype);
if((G__41488__$1 == null)){
return null;
} else {
return G__41488__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41489 = c;
var G__41489__$1 = (((G__41489 == null))?null:G__41489.prototype);
if((G__41489__$1 == null)){
return null;
} else {
return G__41489__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__41592__delegate = function (args){
...
while (G__41593__i < G__41593__a.length) {G__41593__a[G__41593__i] = arguments[G__41593__i + 0]; ++G__41593__i;}
  args = new cljs.core.IndexedSeq(G__41593__a,0,null);
} 
return G__41592__delegate.call(this,args);};
G__41592.cljs$lang$maxFixedArity = 0;
G__41592.cljs$lang$applyTo = (function (arglist__41594){
var args = cljs.core.seq(arglist__41594);
return G__41592__delegate(args);
});
...
var or__4253__auto__ = (function (){var G__41503 = c;
var G__41503__$1 = (((G__41503 == null))?null:G__41503.constructor);
if((G__41503__$1 == null)){
return null;
} else {
return G__41503__$1.displayName;
}
})();
...
var G__41507 = c;
var G__41507__$1 = (((G__41507 == null))?null:G__41507.constructor);
if((G__41507__$1 == null)){
return null;
} else {
return G__41507__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__41544 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41545 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41545);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41544);
}});
...
var c = this;
var G__41582_41600 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__41582_41600 == null)){
} else {
re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__41582_41600);
}
...
var renders_41601 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_41602 = cljs.core.first(cljs.core.vals(renders_41601));
...
if((cljs.core.count(renders_41601) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_41601))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_41602)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_41602], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__41583 = o;
re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.set(G__41583,cljs.core.name(k),v);
...
return (function() { 
var G__41604__delegate = function (args){
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__41605__i < G__41605__a.length) {G__41605__a[G__41605__i] = arguments[G__41605__i + 0]; ++G__41605__i;}
  args = new cljs.core.IndexedSeq(G__41605__a,0,null);
} 
return G__41604__delegate.call(this,args);};
G__41604.cljs$lang$maxFixedArity = 0;
G__41604.cljs$lang$applyTo = (function (arglist__41606){
var args = cljs.core.seq(arglist__41606);
return G__41604__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__41584 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41585 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41585);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41584);
}});
...
var vec__41586 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41586,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41586,(1),null);
...
var G__41589 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__41589 == null)){
return null;
} else {
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__41589);
}
});
}),[]);
