...
var G__48609 = cljs.core.deref(re_frisk.trace.mounted_views);
return (send_views.cljs$core$IFn$_invoke$arity$1 ? send_views.cljs$core$IFn$_invoke$arity$1(G__48609) : send_views.call(null,G__48609));
}));

return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (items,p__48610){
var map__48611 = p__48610;
var map__48611__$1 = cljs.core.__destructure_map(map__48611);
var item = map__48611__$1;
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48611__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48611__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48611__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (items,p__48614){
var map__48615 = p__48614;
var map__48615__$1 = cljs.core.__destructure_map(map__48615);
var trace = map__48615__$1;
...
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48615__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48615__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var op_type__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(op_type),"sub"))?new cljs.core.Keyword(null,"sub","sub",-2093760025):op_type);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48617,new cljs.core.Keyword(null,"db","db",993250759),cljs.core.PersistentArrayMap.EMPTY);
} else {
return G__48617;
}
...
var trace = map__48619__$1;
var subs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48619__$1,new cljs.core.Keyword(null,"subs?","subs?",-2085240020));
var subs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48619__$1,new cljs.core.Keyword(null,"subs","subs",-186681991));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48619__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var handler_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48619__$1,new cljs.core.Keyword(null,"handler-duration","handler-duration",262132324));
var fx_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48619__$1,new cljs.core.Keyword(null,"fx-duration","fx-duration",1796312432));
var raf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48619__$1,new cljs.core.Keyword(null,"raf","raf",-1295410152));
var map__48620 = (cljs.core.truth_(subs_QMARK_)?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([trace,cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__48621){
var map__48622 = p__48621;
var map__48622__$1 = cljs.core.__destructure_map(map__48622);
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48622__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var op_type__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48622__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48622__$1,new cljs.core.Keyword(null,"end","end",-268185958));
var cached_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48622__$1,new cljs.core.Keyword(null,"cached?","cached?",86081880));
var G__48623 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(acc,new cljs.core.Keyword(null,"duration","duration",1444101068),cljs.core._PLUS_,duration);
var G__48623__$1 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48623,new cljs.core.Keyword(null,"end","end",-268185958),end)
;
var G__48623__$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","run","sub/run",-1821315581)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$1,new cljs.core.Keyword(null,"run-count","run-count",-924546145),cljs.core.inc),new cljs.core.Keyword(null,"run-duration","run-duration",1321930251),cljs.core._PLUS_,duration):G__48623__$1);
var G__48623__$3 = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","create","sub/create",-1301317560))) && (cljs.core.not(cached_QMARK_))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$2,new cljs.core.Keyword(null,"created-count","created-count",-1708534686),cljs.core.inc),new cljs.core.Keyword(null,"created-duration","created-duration",-1526658187),cljs.core._PLUS_,duration):G__48623__$2);
var G__48623__$4 = (cljs.core.truth_((function (){var and__4251__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","create","sub/create",-1301317560));
if(and__4251__auto__){
return cached_QMARK_;
} else {
return and__4251__auto__;
}
})())?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$3,new cljs.core.Keyword(null,"created-count-cached","created-count-cached",1601348000),cljs.core.inc),new cljs.core.Keyword(null,"created-duration-cached","created-duration-cached",1269460585),cljs.core._PLUS_,duration):G__48623__$3);
var G__48623__$5 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$4,new cljs.core.Keyword(null,"disposed-count","disposed-count",-457935431),cljs.core.inc),new cljs.core.Keyword(null,"disposed-duration","disposed-duration",-1737482274),cljs.core._PLUS_,duration):G__48623__$4);
var G__48623__$6 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword(null,"render","render",-1408033454)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$5,new cljs.core.Keyword(null,"render-count","render-count",-875399191),cljs.core.inc),new cljs.core.Keyword(null,"render-duration","render-duration",1704092121),cljs.core._PLUS_,duration):G__48623__$5);
var G__48623__$7 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword(null,"force-update","force-update",725693267)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$6,new cljs.core.Keyword(null,"force-count","force-count",-1461582262),cljs.core.inc),new cljs.core.Keyword(null,"force-duration","force-duration",1698459955),cljs.core._PLUS_,duration):G__48623__$6);
var G__48623__$8 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword(null,"create-class","create-class",1988524183)))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$7,new cljs.core.Keyword(null,"create-class-count","create-class-count",910108481),cljs.core.inc),new cljs.core.Keyword(null,"create-class-duration","create-class-duration",-403862588),cljs.core._PLUS_,duration):G__48623__$7);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(op_type__$1,new cljs.core.Keyword(null,"should-upd","should-upd",2083082179))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__48623__$8,new cljs.core.Keyword(null,"shoud-update-count","shoud-update-count",-223224198),cljs.core.inc),new cljs.core.Keyword(null,"shoud-update-duration","shoud-update-duration",-61825976),cljs.core._PLUS_,duration);
} else {
return G__48623__$8;
}
...
var trace__$1 = map__48620__$1;
var render_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"render-duration","render-duration",1704092121));
var disposed_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"disposed-duration","disposed-duration",-1737482274));
var handler_duration__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"handler-duration","handler-duration",262132324));
var create_class_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"create-class-duration","create-class-duration",-403862588));
var shoud_update_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"shoud-update-duration","shoud-update-duration",-61825976));
var created_duration_cached = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"created-duration-cached","created-duration-cached",1269460585));
var run_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"run-duration","run-duration",1321930251));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var fx_duration__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"fx-duration","fx-duration",1796312432));
var force_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"force-duration","force-duration",1698459955));
var created_duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48620__$1,new cljs.core.Keyword(null,"created-duration","created-duration",-1526658187));
var G__48624 = trace__$1;
var G__48624__$1 = (cljs.core.truth_(duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624,new cljs.core.Keyword(null,"duration-ms","duration-ms",1993555055),re_frisk.utils.str_ms(duration)):G__48624);
var G__48624__$2 = (cljs.core.truth_(handler_duration__$1)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$1,new cljs.core.Keyword(null,"handler-duration-ms","handler-duration-ms",-491924416),re_frisk.utils.str_ms(handler_duration__$1)):G__48624__$1);
var G__48624__$3 = (cljs.core.truth_(fx_duration__$1)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$2,new cljs.core.Keyword(null,"fx-duration-ms","fx-duration-ms",-1014211328),re_frisk.utils.str_ms(fx_duration__$1)):G__48624__$2);
var G__48624__$4 = (cljs.core.truth_(run_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$3,new cljs.core.Keyword(null,"run-duration-ms","run-duration-ms",-1510786585),re_frisk.utils.str_ms(run_duration)):G__48624__$3);
var G__48624__$5 = (cljs.core.truth_(created_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$4,new cljs.core.Keyword(null,"created-duration-ms","created-duration-ms",1987553257),re_frisk.utils.str_ms(created_duration)):G__48624__$4);
var G__48624__$6 = (cljs.core.truth_(created_duration_cached)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$5,new cljs.core.Keyword(null,"created-duration-cached-ms","created-duration-cached-ms",1699705669),re_frisk.utils.str_ms(created_duration_cached)):G__48624__$5);
var G__48624__$7 = (cljs.core.truth_(disposed_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$6,new cljs.core.Keyword(null,"disposed-duration-ms","disposed-duration-ms",-1456969189),re_frisk.utils.str_ms(disposed_duration)):G__48624__$6);
var G__48624__$8 = (cljs.core.truth_(render_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$7,new cljs.core.Keyword(null,"render-duration-ms","render-duration-ms",-757772115),re_frisk.utils.str_ms(render_duration)):G__48624__$7);
var G__48624__$9 = (cljs.core.truth_(create_class_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$8,new cljs.core.Keyword(null,"create-class-duration-ms","create-class-duration-ms",1922479072),re_frisk.utils.str_ms(create_class_duration)):G__48624__$8);
var G__48624__$10 = (cljs.core.truth_(shoud_update_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$9,new cljs.core.Keyword(null,"shoud-update-duration-ms","shoud-update-duration-ms",-709397855),re_frisk.utils.str_ms(shoud_update_duration)):G__48624__$9);
var G__48624__$11 = (cljs.core.truth_(force_duration)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$10,new cljs.core.Keyword(null,"force-duration-ms","force-duration-ms",-1303688737),re_frisk.utils.str_ms(force_duration)):G__48624__$10);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48624__$11,new cljs.core.Keyword(null,"position","position",-2011731912),(start - new cljs.core.Keyword(null,"start","start",-355208981).cljs$core$IFn$_invoke$arity$1(first_event)));
