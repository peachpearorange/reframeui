...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),(function (){var G__48538 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"margin","margin",-995903681),(5),new cljs.core.Keyword(null,"padding-left","padding-left",-1180879053),(4),new cljs.core.Keyword(null,"padding-right","padding-right",-1250249681),(4),new cljs.core.Keyword(null,"cursor","cursor",1011937484),new cljs.core.Keyword(null,"pointer","pointer",85071187),new cljs.core.Keyword(null,"border-radius","border-radius",419594011),(4),new cljs.core.Keyword(null,"color","color",1011675173),((active)?new cljs.core.Keyword(null,"white","white",-483998618):new cljs.core.Keyword(null,"gray","gray",1013268388))], null);
var G__48538__$1 = ((active)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48538,new cljs.core.Keyword(null,"background-color","background-color",570434026),"#df691a"):G__48538);
if((!(active))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__48538__$1,new cljs.core.Keyword(null,"border-width","border-width",-1512605390),(1),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"border-color","border-color",-2059162761),new cljs.core.Keyword(null,"gray","gray",1013268388),new cljs.core.Keyword(null,"border-style","border-style",-485574304),new cljs.core.Keyword(null,"solid","solid",-2023773691)], 0));
} else {
return G__48538__$1;
}
...
var map__48543 = cljs.core.second(item);
var map__48543__$1 = cljs.core.__destructure_map(map__48543);
var cnt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48543__$1,new cljs.core.Keyword(null,"cnt","cnt",283978798));
var ms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48543__$1,new cljs.core.Keyword(null,"ms","ms",-1152709733));
...
})], null),"avg. time"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.components.scroller,(function (){var iter__4652__auto__ = (function re_frisk$ui$stat$stat_$_iter__48546(s__48547){
return (new cljs.core.LazySeq(null,(function (){
var s__48547__$1 = s__48547;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__48547__$1);
if(temp__5753__auto__){
var s__48547__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48547__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__48547__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__48549 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__48548 = (0);
while(true){
if((i__48548 < size__4651__auto__)){
var vec__48551 = cljs.core._nth(c__4650__auto__,i__48548);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48551,(0),null);
...
var cnt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword(null,"cnt","cnt",283978798));
var ms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48554__$1,new cljs.core.Keyword(null,"ms","ms",-1152709733));
cljs.core.chunk_append(b__48549,cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"display","display",242065432),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),new cljs.core.Keyword(null,"row","row",-570139521),new cljs.core.Keyword(null,"flex","flex",-1425124628),(1),new cljs.core.Keyword(null,"border-bottom","border-bottom",2110948415),"solid 1px #CCCCCC"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null)], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(key)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),(100)], null)], null),(((cnt > (0)))?cnt:null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"width","width",-384071477),(100)], null)], null),(((((ms > (0))) && ((cnt > (0)))))?re_frisk.utils.str_ms((ms / cnt)):null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(key)].join('')], null)));

var G__48577 = (i__48548 + (1));
i__48548 = G__48577;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48549),re_frisk$ui$stat$stat_$_iter__48546(cljs.core.chunk_rest(s__48547__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48549),null);
}
} else {
var vec__48558 = cljs.core.first(s__48547__$2);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48558,(0),null);
...
return iter__4652__auto__(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3((function (p1__48544_SHARP_){
return re_frisk.ui.stat.sort_fn(cljs.core.deref(re_frisk.ui.stat.sort_by_key),p1__48544_SHARP_);
