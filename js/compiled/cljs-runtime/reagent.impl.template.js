...
var G__39887 = o;
reagent.impl.template.goog$module$goog$object.set(G__39887,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__39908__i < G__39908__a.length) {G__39908__a[G__39908__i] = arguments[G__39908__i + 0]; ++G__39908__i;}
  args = new cljs.core.IndexedSeq(G__39908__a,0,null);
} 
...
var G__39888 = o;
reagent.impl.template.goog$module$goog$object.set(G__39888,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__39889 = props;
var G__39889__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39889,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39889);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39889__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39890 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39890,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39890;
}
})(),id_class);
...
var G__39891 = (cljs.core.count(argv) - first_child);
switch (G__39891) {
case (0):
...
var vec__39892 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39892,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39892,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39892,(2),null);
...
var temp__5757__auto___39922 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___39922 == null)){
} else {
var key_39923 = temp__5757__auto___39922;
(jsprops.key = key_39923);
}
...
var temp__5757__auto___39924 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___39924 == null)){
} else {
var key_39925 = temp__5757__auto___39924;
(jsprops.key = key_39925);
}
...
var temp__5757__auto___39927 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___39927 == null)){
} else {
var key_39928 = temp__5757__auto___39927;
(jsprops.key = key_39928);
}
...
var temp__5757__auto___39933 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___39933 == null)){
} else {
var key_39935 = temp__5757__auto___39933;
(jsprops.key = key_39935);
}
...
var temp__5757__auto___39936 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___39936 == null)){
} else {
var key_39937 = temp__5757__auto___39936;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39895_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39895_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39896 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39896,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39896,(1),null);
...
break;
default:
var G__39943 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39944 = compiler;
v = G__39943;
compiler = G__39944;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39902 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39902 = (function (opts,id,fn_to_element,parse_fn,meta39903){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39902.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39904,meta39903__$1){
var self__ = this;
var _39904__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39902(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39903__$1));
}));

(reagent.impl.template.t_reagent$impl$template39902.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39904){
var self__ = this;
var _39904__$1 = this;
return self__.meta39903;
}));

(reagent.impl.template.t_reagent$impl$template39902.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39902.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39902.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39902.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39902.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39902.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39903","meta39903",-1006180512,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39902.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39902.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39902");

(reagent.impl.template.t_reagent$impl$template39902.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template39902");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39902.
 */
reagent.impl.template.__GT_t_reagent$impl$template39902 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39902(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta39903){
return (new reagent.impl.template.t_reagent$impl$template39902(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta39903));
});

}

return (new reagent.impl.template.t_reagent$impl$template39902(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
