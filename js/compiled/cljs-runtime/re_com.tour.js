...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__47073_SHARP_,p2__47074_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__47073_SHARP_,p2__47074_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4652__auto__ = (function re_com$tour$initialise_tour_$_iter__47079(s__47080){
return (new cljs.core.LazySeq(null,(function (){
var s__47080__$1 = s__47080;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__47080__$1);
if(temp__5753__auto__){
var s__47080__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47080__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__47080__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__47082 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__47081 = (0);
while(true){
if((i__47081 < size__4651__auto__)){
var step = cljs.core._nth(c__4650__auto__,i__47081);
cljs.core.chunk_append(b__47082,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__47153 = (i__47081 + (1));
i__47081 = G__47153;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47082),re_com$tour$initialise_tour_$_iter__47079(cljs.core.chunk_rest(s__47080__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47082),null);
}
} else {
var step = cljs.core.first(s__47080__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__47079(cljs.core.rest(s__47080__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__47119 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__47119.cljs$core$IFn$_invoke$arity$1 ? fexpr__47119.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__47119.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__47131 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__47131.cljs$core$IFn$_invoke$arity$1 ? fexpr__47131.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__47131.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__47132 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__47132.cljs$core$IFn$_invoke$arity$1 ? fexpr__47132.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__47132.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__47142 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__47142.cljs$core$IFn$_invoke$arity$1 ? fexpr__47142.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__47142.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__47143 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__47143.cljs$core$IFn$_invoke$arity$1 ? fexpr__47143.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__47143.call(null,tour));
})(),true);
} else {
return null;
}
