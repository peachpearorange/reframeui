 ...
 */
garden.units.convert = (function garden$units$convert(p__54950,right){
var map__54951 = p__54950;
var map__54951__$1 = cljs.core.__destructure_map(map__54951);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54951__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54951__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__54954 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54954,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54954,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54954,(2),null);
...
var map__54969 = u(x);
var map__54969__$1 = cljs.core.__destructure_map(map__54969);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54969__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54970 = u(y);
var map__54970__$1 = cljs.core.__destructure_map(map__54970);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54970__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__55032__delegate = function (x,y,more){
...
var G__55032 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__55033__i = 0, G__55033__a = new Array(arguments.length -  2);
while (G__55033__i < G__55033__a.length) {G__55033__a[G__55033__i] = arguments[G__55033__i + 2]; ++G__55033__i;}
  more = new cljs.core.IndexedSeq(G__55033__a,0,null);
} 
return G__55032__delegate.call(this,x,y,more);};
G__55032.cljs$lang$maxFixedArity = 2;
G__55032.cljs$lang$applyTo = (function (arglist__55034){
var x = cljs.core.first(arglist__55034);
arglist__55034 = cljs.core.next(arglist__55034);
var y = cljs.core.first(arglist__55034);
var more = cljs.core.rest(arglist__55034);
return G__55032__delegate(x,y,more);
});
...
var G__55035 = null;
if (arguments.length > 2) {
var G__55036__i = 0, G__55036__a = new Array(arguments.length -  2);
while (G__55036__i < G__55036__a.length) {G__55036__a[G__55036__i] = arguments[G__55036__i + 2]; ++G__55036__i;}
G__55035 = new cljs.core.IndexedSeq(G__55036__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__55035);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54972__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54973 = u(y);
var map__54973__$1 = cljs.core.__destructure_map(map__54973);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54973__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__55037__delegate = function (x,y,more){
...
var G__55037 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__55039__i = 0, G__55039__a = new Array(arguments.length -  2);
while (G__55039__i < G__55039__a.length) {G__55039__a[G__55039__i] = arguments[G__55039__i + 2]; ++G__55039__i;}
  more = new cljs.core.IndexedSeq(G__55039__a,0,null);
} 
return G__55037__delegate.call(this,x,y,more);};
G__55037.cljs$lang$maxFixedArity = 2;
G__55037.cljs$lang$applyTo = (function (arglist__55040){
var x = cljs.core.first(arglist__55040);
arglist__55040 = cljs.core.next(arglist__55040);
var y = cljs.core.first(arglist__55040);
var more = cljs.core.rest(arglist__55040);
return G__55037__delegate(x,y,more);
});
...
var G__55043 = null;
if (arguments.length > 2) {
var G__55044__i = 0, G__55044__a = new Array(arguments.length -  2);
while (G__55044__i < G__55044__a.length) {G__55044__a[G__55044__i] = arguments[G__55044__i + 2]; ++G__55044__i;}
G__55043 = new cljs.core.IndexedSeq(G__55044__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__55043);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54976__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54977 = u(y);
var map__54977__$1 = cljs.core.__destructure_map(map__54977);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54977__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__55045__delegate = function (x,y,more){
...
var G__55045 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__55046__i = 0, G__55046__a = new Array(arguments.length -  2);
while (G__55046__i < G__55046__a.length) {G__55046__a[G__55046__i] = arguments[G__55046__i + 2]; ++G__55046__i;}
  more = new cljs.core.IndexedSeq(G__55046__a,0,null);
} 
return G__55045__delegate.call(this,x,y,more);};
G__55045.cljs$lang$maxFixedArity = 2;
G__55045.cljs$lang$applyTo = (function (arglist__55047){
var x = cljs.core.first(arglist__55047);
arglist__55047 = cljs.core.next(arglist__55047);
var y = cljs.core.first(arglist__55047);
var more = cljs.core.rest(arglist__55047);
return G__55045__delegate(x,y,more);
});
...
var G__55048 = null;
if (arguments.length > 2) {
var G__55049__i = 0, G__55049__a = new Array(arguments.length -  2);
while (G__55049__i < G__55049__a.length) {G__55049__a[G__55049__i] = arguments[G__55049__i + 2]; ++G__55049__i;}
G__55048 = new cljs.core.IndexedSeq(G__55049__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__55048);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54980__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__54981 = u(y);
var map__54981__$1 = cljs.core.__destructure_map(map__54981);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54981__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__55051__delegate = function (x,y,more){
...
var G__55051 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__55052__i = 0, G__55052__a = new Array(arguments.length -  2);
while (G__55052__i < G__55052__a.length) {G__55052__a[G__55052__i] = arguments[G__55052__i + 2]; ++G__55052__i;}
  more = new cljs.core.IndexedSeq(G__55052__a,0,null);
} 
return G__55051__delegate.call(this,x,y,more);};
G__55051.cljs$lang$maxFixedArity = 2;
...
return G__55051__delegate(x,y,more);
});
...
var G__55054 = null;
if (arguments.length > 2) {
var G__55055__i = 0, G__55055__a = new Array(arguments.length -  2);
while (G__55055__i < G__55055__a.length) {G__55055__a[G__55055__i] = arguments[G__55055__i + 2]; ++G__55055__i;}
G__55054 = new cljs.core.IndexedSeq(G__55055__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__55054);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
