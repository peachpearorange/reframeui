...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__47982,new_key_fn,new_comp){
var map__47983 = p__47982;
var map__47983__$1 = cljs.core.__destructure_map(map__47983);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47983__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47983__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__48032,parts,sort_by_column){
var map__48033 = p__48032;
var map__48033__$1 = cljs.core.__destructure_map(map__48033);
var column = map__48033__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"header-label","header-label",765876429));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48033__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var map__48034 = sort_by;
var map__48034__$1 = cljs.core.__destructure_map(map__48034);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48034__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479),row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48034__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var map__48035 = cljs.core.deref(sort_by_column);
var map__48035__$1 = cljs.core.__destructure_map(map__48035);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48035__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48035__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-column-header","simple-column-header",-1241463404),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__4652__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__48061(s__48062){
return (new cljs.core.LazySeq(null,(function (){
var s__48062__$1 = s__48062;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__48062__$1);
if(temp__5753__auto__){
var s__48062__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48062__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__48062__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__48064 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__48063 = (0);
while(true){
if((i__48063 < size__4651__auto__)){
var column = cljs.core._nth(c__4650__auto__,i__48063);
cljs.core.chunk_append(b__48064,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__48291 = (i__48063 + (1));
i__48063 = G__48291;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48064),re_com$simple_v_table$column_header_renderer_$_iter__48061(cljs.core.chunk_rest(s__48062__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48064),null);
}
} else {
var column = cljs.core.first(s__48062__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__48061(cljs.core.rest(s__48062__$2)));
}
} else {
return null;
}
 ...
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__48118,cell_style,parts){
var map__48119 = p__48118;
var map__48119__$1 = cljs.core.__destructure_map(map__48119);
var column = map__48119__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48119__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48119__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48119__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48119__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48119__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-row","simple-row",-252554766),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__4652__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__48136(s__48137){
return (new cljs.core.LazySeq(null,(function (){
var s__48137__$1 = s__48137;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__48137__$1);
if(temp__5753__auto__){
var s__48137__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__48137__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__48137__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__48139 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__48138 = (0);
while(true){
if((i__48138 < size__4651__auto__)){
var column = cljs.core._nth(c__4650__auto__,i__48138);
cljs.core.chunk_append(b__48139,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__48292 = (i__48138 + (1));
i__48138 = G__48292;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48139),re_com$simple_v_table$row_renderer_$_iter__48136(cljs.core.chunk_rest(s__48137__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__48139),null);
}
} else {
var column = cljs.core.first(s__48137__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__48136(cljs.core.rest(s__48137__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48172_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__48172_SHARP_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.inc);
...
var len__4864__auto___48309 = arguments.length;
var i__4865__auto___48310 = (0);
while(true){
if((i__4865__auto___48310 < len__4864__auto___48309)){
args__4870__auto__.push((arguments[i__4865__auto___48310]));

var G__48311 = (i__4865__auto___48310 + (1));
i__4865__auto___48310 = G__48311;
continue;
} else {
}
break;
...
(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__48184){
var map__48185 = p__48184;
var map__48185__$1 = cljs.core.__destructure_map(map__48185);
var args = map__48185__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48185__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
...
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__48186){
var map__48187 = p__48186;
var map__48187__$1 = cljs.core.__destructure_map(map__48187);
var args__$1 = map__48187__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"cell-style","cell-style",1087536089));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"on-leave-row","on-leave-row",1361264390));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"on-enter-row","on-enter-row",-139996948));
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48187__$1,new cljs.core.Keyword(null,"row-height","row-height",527360749),(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"max-width","max-width",-1939924051));
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"on-click-row","on-click-row",-383826673));
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48187__$1,new cljs.core.Keyword(null,"table-row-line-color","table-row-line-color",680569135),"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48187__$1,new cljs.core.Keyword(null,"table-padding","table-padding",-702873839),(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48187__$1,new cljs.core.Keyword(null,"column-header-height","column-header-height",-1680092558),(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"row-style","row-style",1352472052));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48187__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48187__$1,new cljs.core.Keyword(null,"fixed-column-border-color","fixed-column-border-color",2036669142),"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48187__$1,new cljs.core.Keyword(null,"column-header-renderer","column-header-renderer",-1886265578),re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48187__$1,new cljs.core.Keyword(null,"fixed-column-count","fixed-column-count",721535030),(0));
...
var map__48216 = temp__5751__auto__;
var map__48216__$1 = cljs.core.__destructure_map(map__48216);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48216__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__48216__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48216__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
var G__48322__i = 0, G__48322__a = new Array(arguments.length -  0);
while (G__48322__i < G__48322__a.length) {G__48322__a[G__48322__i] = arguments[G__48322__i + 0]; ++G__48322__i;}
  p__48186 = new cljs.core.IndexedSeq(G__48322__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__48186);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__48323){
var p__48186 = cljs.core.seq(arglist__48323);
return re_com$simple_v_table$simple_v_table_render__delegate(p__48186);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq48183){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48183));
}));
