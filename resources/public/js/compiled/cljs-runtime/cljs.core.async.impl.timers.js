...
var i_45755 = (0);
while(true){
if((i_45755 < arr.length)){
(arr[i_45755] = null);

var G__45756 = (i_45755 + (1));
i_45755 = G__45756;
continue;
} else {
}
...
var i_45763 = (self__.level + (1));
while(true){
if((i_45763 <= (new_level + (1)))){
(update[i_45763] = self__.header);

var G__45764 = (i_45763 + (1));
i_45763 = G__45764;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_45767 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_45767[i]));
} else {
x__$2.forward.push((((i < links_45767.length))?(links_45767[i]):null));
}

if((i < links_45767.length)){
(links_45767[i] = x__$2);
} else {
links_45767.push(x__$2);
}
...
var i_45770 = (0);
while(true){
if((i_45770 <= self__.level)){
var links_45771 = (update[i_45770]).forward;
if((x__$1 === (((i_45770 < links_45771.length))?(links_45771[i_45770]):null))){
(links_45771[i_45770] = (x__$1.forward[i_45770]));

var G__45773 = (i_45770 + (1));
i_45770 = G__45773;
continue;
} else {
var G__45774 = (i_45770 + (1));
i_45770 = G__45774;
continue;
}
} else {
