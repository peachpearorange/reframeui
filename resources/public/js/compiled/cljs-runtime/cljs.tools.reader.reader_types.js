...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41937 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41937(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41938 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41938(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41939 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41939(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41940 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41940(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41941 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41941(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41942 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41942(reader);
}
});
...
var G__41964 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41965 = s.append(c);
c = G__41964;
s = G__41965;
continue;
}
