...
var len__4864__auto___39092 = arguments.length;
var i__4865__auto___39093 = (0);
while(true){
if((i__4865__auto___39093 < len__4864__auto___39092)){
args__4870__auto__.push((arguments[i__4865__auto___39093]));

var G__39094 = (i__4865__auto___39093 + (1));
i__4865__auto___39093 = G__39094;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39063){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39064,G__39065,seq39063__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39071_SHARP_){
return (!((cljs.core.meta(p1__39071_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39072__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e39073){var _e__36230__auto__ = e39073;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e39075){var _e__36230__auto__ = e39075;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__39084 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__39085 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__39085);

try{var map__39086 = opts;
var map__39086__$1 = cljs.core.__destructure_map(map__39086);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39086__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__39084);
}});
...
var temp__5751__auto___39098 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___39098)){
var managed_print_level_39099 = temp__5751__auto___39098;
var _STAR_print_level_STAR__orig_val__39088_39100 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__39089_39101 = managed_print_level_39099;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__39089_39101);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__39087_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__39087_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__39088_39100);
}} else {
job_fn();
}
